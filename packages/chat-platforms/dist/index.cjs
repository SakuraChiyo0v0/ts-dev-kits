...
var logger$2 = require('@sakurachiyo0v0/logger');
...
const logger$1 = logger$2.createLogger({ namespace: "chat-platforms" }).child("client");
/**
...
const logger = logger$2.createLogger({ namespace: "chat-platforms" }).child("feishu");
/**
 * 飞书适配器。
