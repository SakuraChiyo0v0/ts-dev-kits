...
export type PolicyDecision =
  | { action: "respond"; reaction?: string; strippedText?: string }
  | { action: "ignore"; reason: string }
  | { action: "blocked"; replyText: string };

/** 默认策略：全放行，不限制 */
export function defaultPolicy(): ChatResponsePolicy {
  return {
...
export function validatePolicy(policy: ChatResponsePolicy): string | null {
