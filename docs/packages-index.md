...
| `@sakurachiyo0v0/media-downloader` | 0.2.1 | 通用媒体下载 SDK:目录选择/流式下载+重试+进度/元数据封面写入/下载历史 | 可用 | `git+https://github.com/SakuraChiyo0v0/ts-dev-kits.git#path:/packages/media-downloader` |
